...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default= 'config/shapenet/shapenet_transformer.yaml',
                        help='config file')
    parser.add_argument('opts', help='see', default=None,
...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    if args.data_name == 's3dis':
        ...
        train_data = ShapeNetPart(partition='train', data_root=args.data_root,
                                  voxel_size=args.voxel_size, voxel_max=args.voxel_max, transform=train_transform,
                                  shuffle_index=True, loop=args.loop)
    else:
    ...
    if args.data_name == 's3dis':
        ...
        val_data = ShapeNetPart(partition='train', data_root=args.data_root,
                                voxel_size=args.voxel_size, voxel_max=args.voxel_max, transform=train_transform)
    else:
        raise ValueError("The dataset {} is not supported.".format(args.data_name))
